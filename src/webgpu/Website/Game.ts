...
export default class Game{
  ...
  private camTargetStart=new Vector3(-0.12800455804343508, 0.5956693601780412, 0.10405709)
    ...
    setActive() {
        ...
        tl.to(this.camWorld,{x:this.camWorldEnd.x,y:this.camWorldEnd.y,z:this.camWorldEnd.z,duration:6,ease:"power4.out"},1)
        tl.to(this.camTarget,{x:this.camTargetEnd.x,y:this.camTargetEnd.y,z:this.camTargetEnd.z,duration:6,ease:"power4.out"},1)
        tl.call(()=>{
            this.mofo.play =true;
        },[],3)
