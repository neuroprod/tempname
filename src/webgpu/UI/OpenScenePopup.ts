...
export function setOpenScenePopup(title: string, items:Array<any>, callBack: (item:any) => void) {
    ...
    let compPopup = new OpenScenePopup(
...
export  class OpenScenePopup extends PopUp{
    ...
    constructor(id:number, settings:PopUpSettings,title:string,items:Array<any>, callBack: (item:string) => void) {
        super(id,settings);
        this.title =title;
